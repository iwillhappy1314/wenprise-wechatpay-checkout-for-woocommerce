...
use Wenprise\Wechatpay\GuzzleHttp\Exception as GuzzleExceptions;
use Wenprise\Wechatpay\GuzzleHttp\Promise\PromiseInterface;
use Wenprise\Wechatpay\Http\Adapter\Guzzle6\Exception\UnexpectedValueException;
use Wenprise\Wechatpay\Http\Client\Exception as HttplugException;
use Wenprise\Wechatpay\Http\Promise\Promise as HttpPromise;
