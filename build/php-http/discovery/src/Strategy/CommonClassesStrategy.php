...
namespace Wenprise\Wechatpay\Http\Discovery\Strategy;

use Wenprise\Wechatpay\GuzzleHttp\Client as GuzzleHttp;
use Wenprise\Wechatpay\GuzzleHttp\Promise\Promise;
use Wenprise\Wechatpay\GuzzleHttp\Psr7\Request as GuzzleRequest;
use Http\Adapter\Artax\Client as Artax;
use Http\Adapter\Buzz\Client as Buzz;
use Http\Adapter\Cake\Client as Cake;
use Http\Adapter\Guzzle5\Client as Guzzle5;
use Wenprise\Wechatpay\Http\Adapter\Guzzle6\Client as Guzzle6;
use Http\Adapter\Guzzle7\Client as Guzzle7;
use Http\Adapter\React\Client as React;
use Wenprise\Wechatpay\Http\Client\Curl\Client as Curl;
use Wenprise\Wechatpay\Http\Client\HttpAsyncClient;
use Wenprise\Wechatpay\Http\Client\HttpClient;
use Wenprise\Wechatpay\Http\Client\Socket\Client as Socket;
use Wenprise\Wechatpay\Http\Discovery\ClassDiscovery;
use Wenprise\Wechatpay\Http\Discovery\Exception\NotFoundException;
use Wenprise\Wechatpay\Http\Discovery\Psr17FactoryDiscovery;
use Wenprise\Wechatpay\Http\Message\MessageFactory;
use Wenprise\Wechatpay\Http\Message\MessageFactory\DiactorosMessageFactory;
use Wenprise\Wechatpay\Http\Message\MessageFactory\GuzzleMessageFactory;
use Wenprise\Wechatpay\Http\Message\MessageFactory\SlimMessageFactory;
use Wenprise\Wechatpay\Http\Message\StreamFactory;
use Wenprise\Wechatpay\Http\Message\StreamFactory\DiactorosStreamFactory;
use Wenprise\Wechatpay\Http\Message\StreamFactory\GuzzleStreamFactory;
use Wenprise\Wechatpay\Http\Message\StreamFactory\SlimStreamFactory;
use Wenprise\Wechatpay\Http\Message\UriFactory;
use Wenprise\Wechatpay\Http\Message\UriFactory\DiactorosUriFactory;
use Wenprise\Wechatpay\Http\Message\UriFactory\GuzzleUriFactory;
use Wenprise\Wechatpay\Http\Message\UriFactory\SlimUriFactory;
use Laminas\Diactoros\Request as DiactorosRequest;
use Nyholm\Psr7\Factory\HttplugFactory as NyholmHttplugFactory;
use Wenprise\Wechatpay\Psr\Http\Client\ClientInterface as Psr18Client;
use Wenprise\Wechatpay\Psr\Http\Message\RequestFactoryInterface as Psr17RequestFactory;
...
final class CommonClassesStrategy implements DiscoveryStrategy
{
    ...
    {
        return defined('Wenprise\Wechatpay\GuzzleHttp\ClientInterface::MAJOR_VERSION');
    }
