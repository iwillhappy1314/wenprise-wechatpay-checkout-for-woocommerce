...
namespace Wenprise\Wechatpay\Http\Discovery\Composer;
...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    private const INTERFACE_MAP = [
        'php-http/async-client-implementation' => [
            'Wenprise\Wechatpay\Http\Client\HttpAsyncClient',
        ],
        'php-http/client-implementation' => [
            'Wenprise\Wechatpay\Http\Client\HttpClient',
        ],
        'psr/http-client-implementation' => [
            'Wenprise\Wechatpay\Psr\Http\Client\ClientInterface',
        ],
        'psr/http-factory-implementation' => [
            'Wenprise\Wechatpay\Psr\Http\Message\RequestFactoryInterface',
            'Wenprise\Wechatpay\Psr\Http\Message\ResponseFactoryInterface',
            'Wenprise\Wechatpay\Psr\Http\Message\ServerRequestFactoryInterface',
            'Wenprise\Wechatpay\Psr\Http\Message\StreamFactoryInterface',
            'Wenprise\Wechatpay\Psr\Http\Message\UploadedFileFactoryInterface',
            'Wenprise\Wechatpay\Psr\Http\Message\UriFactoryInterface',
        ],
    ];
