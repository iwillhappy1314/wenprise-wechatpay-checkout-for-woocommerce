...
use Wenprise\Wechatpay\Http\Discovery\Exception\ClassInstantiationFailedException;
use Wenprise\Wechatpay\Http\Discovery\Exception\DiscoveryFailedException;
use Wenprise\Wechatpay\Http\Discovery\Exception\NoCandidateFoundException;
use Wenprise\Wechatpay\Http\Discovery\Exception\StrategyUnavailableException;
use Wenprise\Wechatpay\Http\Discovery\Strategy\DiscoveryStrategy;
