...
class Helper
{
    ...
    public static function getGatewayShortName($className)
    {
        ...
        if (0 === strpos($className, 'Wenprise\\Wechatpay\\Omnipay\\')) {
     ...
     *      Stripe              => \Wenprise\Wechatpay\Omnipay\Stripe\Gateway
     *      PayPal\Express      => \Wenprise\Wechatpay\Omnipay\PayPal\ExpressGateway
     *      PayPal_Express      => \Wenprise\Wechatpay\Omnipay\PayPal\ExpressGateway
     *
    ...
    public static function getGatewayClassName($shortName)
    {
        ...
        if (0 === strpos($shortName, '\\') || 0 === strpos($shortName, 'Wenprise\\Wechatpay\\Omnipay\\')) {
            return $shortName;
        }
        ...
        return '\\Wenprise\\Wechatpay\\Omnipay\\'.$shortName.'Gateway';
    }
}
