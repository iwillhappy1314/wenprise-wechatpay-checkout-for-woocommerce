...
use Wenprise\Wechatpay\Symfony\Component\HttpFoundation\Session\SessionBagInterface;
use Wenprise\Wechatpay\Symfony\Component\HttpFoundation\Session\SessionUtils;
use Wenprise\Wechatpay\Symfony\Component\HttpFoundation\Session\Storage\Handler\StrictSessionHandler;
use Wenprise\Wechatpay\Symfony\Component\HttpFoundation\Session\Storage\Proxy\AbstractProxy;
use Wenprise\Wechatpay\Symfony\Component\HttpFoundation\Session\Storage\Proxy\SessionHandlerProxy;
...
class NativeSessionStorage implements SessionStorageInterface
{
    ...
    {
        if (!\extension_loaded('Wenprise\Wechatpay\session')) {
            throw new \LogicException('PHP extension "Wenprise\Wechatpay\session" is required.');
        }
